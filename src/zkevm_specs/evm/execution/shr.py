...
def shr(instruction: Instruction):
    ...
    def word_shift_right(a: RLC, shift: RLC) -> RLC:
        ...
        return instruction.select(
            shift_valid,
            word_shift_right_with_integer(a, instruction.bytes_to_fq(shift_lo)),
            RLC(0),
        )

    def word_shift_right_with_integer(a: RLC, shift: FQ) -> RLC:
