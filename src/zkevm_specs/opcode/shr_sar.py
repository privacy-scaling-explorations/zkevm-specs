...
@is_circuit_code
def check_shr_sar(a: Sequence[U8],
                  b: Sequence[U8],
                  shift: U8,
    ...
    for transplacement in range(4):
        ...
        for idx in range(4 - transplacement):
            ...
            if tmp_idx == 3:
                merge_a = a_slice_front_digits[tmp_idx] + signed_num * high_pow
            else:
        ...
        for idx in range(4 - transplacement, 4):
            assert select_transplacement_polynomial * (b_digits[idx] - signed_num * m256_64) == 0
