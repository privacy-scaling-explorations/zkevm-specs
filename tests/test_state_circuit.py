...
def test_state_ok():
    ...
    ops = [
        ...
        TxReceiptOp(rw_counter=33, rw=RW.Read, tx_id=1, field_tag=TxReceiptFieldTag.CumulativeGasUsed, value=FQ(200)),
        TxReceiptOp(rw_counter=34, rw=RW.Read, tx_id=2, field_tag=TxReceiptFieldTag.PostStateOrStatus, value=FQ(1)),
