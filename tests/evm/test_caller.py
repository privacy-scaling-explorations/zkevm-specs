...
def test_caller(caller: U160):
    ...
    tables = Tables(
        ...
        rw_table=set(
            [
                (9, RW.Write, RWTableTag.Stack, 1, 1023, 0, RLC(caller, randomness, 20), 0, 0, 0),
                (10, RW.Read, RWTableTag.CallContext, 1, CallContextFieldTag.CallerAddress, 0, caller, 0, 0, 0),
            ]
        ),
    )
