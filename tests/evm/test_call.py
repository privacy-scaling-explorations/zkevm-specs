...
CALLEE_WITH_BALANCE = Account(address=0xFF, balance=int(1e18))
...
def test_call(
    ...
    tables = Tables(
        ...
        rw_table=set(
            ...
            .tx_access_list_account_write(1, callee.address, 1, 0, caller_ctx.rw_counter_end_of_reversion - caller_ctx.state_write_counter)
            ...
            .account_write(caller.address, AccountFieldTag.Balance, caller_balance, caller_balance_prev, callee_rw_counter_end_of_reversion)
            .account_write(callee.address, AccountFieldTag.Balance, callee_balance, callee_balance_prev, callee_rw_counter_end_of_reversion - 1)
