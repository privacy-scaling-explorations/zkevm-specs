...
def test_gaslimit(gaslimit: U64):
    ...
    tables = Tables(
        ...
        tx_table=set(),
        bytecode_table=set(bytecode.table_assignments(randomness)),
        rw_table=set(RWDictionary(9).stack_write(1, 1023, RLC(gaslimit, randomness)).rws),
    )
...
def test_difficulty(difficulty: U256):
    ...
    tables = Tables(
        ...
        tx_table=set(),
        bytecode_table=set(bytecode.table_assignments(randomness)),
        rw_table=set(RWDictionary(9).stack_write(1, 1023, RLC(difficulty, randomness)).rws),
    )
...
def test_basefee(basefee: U256):
    ...
    tables = Tables(
        ...
        tx_table=set(),
        bytecode_table=set(bytecode.table_assignments(randomness)),
        rw_table=set(RWDictionary(9).stack_write(1, 1023, RLC(basefee, randomness)).rws),
    )
