...
def test_begin_tx():
    ...
    tables = Tables(
        ...
        rw_table=set([
            ...
            (2, RW.Write, RWTableTag.Account, tx.caller_address, AccountFieldTag.Nonce, tx.nonce + 1, tx.nonce, 0),
            (3, RW.Write, RWTableTag.TxAccessListAccount, 1, tx.caller_address, 1, 0, 0),
            (4, RW.Write, RWTableTag.TxAccessListAccount, 1, tx.callee_address, 1, 0, 0),
            (5, RW.Read, RWTableTag.CallContext, 1, CallContextFieldTag.RWCounterEndOfReversion, 0, 0, 0),
            (6, RW.Read, RWTableTag.CallContext, 1, CallContextFieldTag.IsPersistent, 1, 0, 0),
